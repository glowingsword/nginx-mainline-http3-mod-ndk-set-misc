...
pkgname=(nginx-mainline-http3-mod-ndk nginx-mainline-http3-mod-set-misc)
pkgver=$_setmiscver_$_ndkver
pkgrel=3

arch=('x86_64')
depends=('nginx-mainline-http3')
...
package_nginx-mainline-http3-mod-ndk() {
...
package_nginx-mainline-http3-mod-set-misc() {
	pkgdesc="Nginx module that adds various set_xxx directives"
	depends=("nginx-mainline-http3" 'nginx-mainline-http3-mod-ndk')
